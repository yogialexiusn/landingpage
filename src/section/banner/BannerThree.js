...
const BannerThree = (props) => {
  ...
  return (
    ...
    >
      <HeaderMain
        className={`header-main header-main-s1 is-sticky is-transparent on-dark ${
          offset > 0 ? "has-fixed" : ""
        }`}
      >
        <Container className="header-container">
          <HeaderWrap>
            ...
            >
              {!mobileView ? (
                <Menu className="ms-lg-auto" data={BannerThreeData} />
              ) : (
                <MobileMenu data={BannerThreeData} />
              )}
          ...
          <Row className="flex-row-reverse align-items-center justify-content-between g-gs">
            ...
            <Col lg="6">
              <HeaderCaption>
                ...
                <HeaderTitle>
                  Professional &amp; Creative Design Solution
                </HeaderTitle>
                <HeaderText className="pe-5">
                  <p>
                    Nemo enim ipsam voluptatem quia volup tas sit aut aspernatur
                    aut fugit sed quia consequuntur voluptatem nesciunt.
                  </p>
                </HeaderText>
