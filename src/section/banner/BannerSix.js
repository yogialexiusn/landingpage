...
const BannerSix = (props) => {
  ...
  return (
    ...
    >
      <HeaderMain
        className={`header-main-s1 is-sticky is-transparent on-dark ${
          offset > 0 ? "has-fixed" : ""
        }`}
      >
        <Container className="header-container">
          <HeaderWrap>
            ...
            >
              {!mobileView ? (
                <Menu className="ms-lg-auto" data={BannerSixData} />
              ) : (
                <MobileMenu data={BannerSixData} />
              )}
          ...
          <Row className="flex-lg-row-reverse align-items-center justify-content-between g-gs">
            ...
            <Col lg="5" md="10">
              <HeaderCaption>
                ...
                <HeaderTitle className="fw-medium">
                  Tools Made For Creative Profesional
                </HeaderTitle>
                <HeaderText>
                  <p>
                    Powerful dashboard template that especially build for
                ...
                <ul className="header-action btns-inline">
                  ...
                  <li>
                    <a
                      ...
                      href="#0"
                      className="link link-block link-primary popup-video"
                    >
