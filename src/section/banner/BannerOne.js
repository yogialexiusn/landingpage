...
const BannerOne = (props) => {
  ...
  return (
    ...
    >
      <HeaderMain
        className={`header-main header-main-s1 is-sticky on-dark is-transparent ${
          offset > 0 ? "has-fixed" : ""
        }`}
      >
        <Container className="header-container">
          <HeaderWrap>
            ...
            >
              {!mobileView ? (
                <Menu className="ms-lg-auto" data={BannerOneData} />
              ) : (
                <MobileMenu data={BannerOneData} />
              )}
        ...
        <div className="container">
          <Row className="row justify-content-center text-center">
            <Col lg="7" md="10">
              <HeaderCaption>
                <HeaderTitle>
                  Instantly upload any software usage nio saasbox data
                </HeaderTitle>
                <HeaderText>
                  <p>
                    A powerful admin dashboard template that especially build
                    for developers and programmers. DashLite comes with all kind
                    of components.
                  </p>
                </HeaderText>
