        ...
        <Section className = {props.className && props.className} id={props.id && props.id}>
            <Container>
                <Row className="g-gs justify-content-between align-items-center">
                    ...
                    <Col lg="5">
                        <TextBlock>
                            <h3 className="mb-30" style={{textAlign: 'center'}}>LOTTE DATA COMMUNICATION</h3>
                            <br></br>
            ...
            <Row className="g-gs flex-row-reverse justify-content-between align-items-center">
                    ...
                    <Col lg="5">
                        <TextBlock>
                        <h3 className="mb-30" style={{textAlign: 'center'}}>LOTTE DATA COMMUNICATION INDONESIA</h3>
                        <br></br>
                            <ul className="list list-lg list-purple list-checked-circle gy-1">
                                <li className="ps-5"><strong>CEO</strong> : Cho, Chung-Hwan</li>
                                <li className="ps-5"><strong>Established</strong> :  October 18, 2010</li>
                                <li className="ps-5"><strong>Capital</strong> :  US$ 500,000 (PMA)</li>
                                <li className="ps-5"><strong>HO</strong> :  Pasar Rebo Jakarta Timur</li>
                                <li className="ps-5"><strong>Data Center</strong> :  Lotte Avenue 8th Floor Jakarta Selatan</li>
                                <li className="ps-5"><strong>Biz Area</strong> :  SI, SM, HW, SW, Solution, Infrastructure</li>
                                <li className="ps-5"><strong>Employees</strong> :  72 (2022.12, Full-time Employees)</li>
                            </ul>
                        </TextBlock>
                    </Col>
                </Row>
