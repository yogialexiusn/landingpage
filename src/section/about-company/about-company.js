          ...
          <Col lg="5">
            <TextBlock>
              ...
              <ul className="list list-lg list-purple list-checked-circle gy-1">
                ...
                <li className="ps-5">
                  <strong>Annual Sales</strong> : 1 trillion 47.7 billion (as of
                  2022.12)
                </li>
                <li className="ps-5">
          ...
          <Col lg="5">
            <TextBlock>
              ...
              <ul className="list list-lg list-purple list-checked-circle gy-1">
                ...
                <li className="ps-5">
                  <strong>Data Center</strong> : Lotte Avenue 8th Floor Jakarta
                  Selatan
                </li>
                <li className="ps-5">
                  <strong>Biz Area</strong> : SI, SM, HW, SW, Solution,
                  Infrastructure
                </li>
                <li className="ps-5">
