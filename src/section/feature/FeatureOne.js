        ...
        <Row className="justify-content-between align-items-center">
          ...
          <Col lg="6">
            <TextBlock className="pe-xl-5">
              ...
              <Paragraph>
                LOTTE is expanding its social welfare infrastructure to make the
                world a better place, and implementing various aid and support
                programs to help the socially vulnerable.
              </Paragraph>
              <OutlinedChecked
                className="list-lg list-success list-checked-circle outlined"
                data={FeatureOneList}
              />
        ...
        <Row className="flex-row-reverse justify-content-between align-items-center">
          ...
          <Col lg="5">
            <TextBlock className="pe-xl-5">
              ...
              <Paragraph>
                Since the establishment in Indonesia in 2010, LOTTE DATA
                COMMUNICATION INDONESIA is making a new leap forward.
              </Paragraph>
              <OutlinedChecked
                className="list-lg list-success list-checked-circle outlined"
