                ...
                <Row className='justify-content-between align-items-center'>
                    ...
                    <Col lg='6'>
                        <TextBlock className='pe-xl-5'>
                            ...
                            <Paragraph>
                                LOTTE is expanding its social welfare infrastructure to make the world a better place, and implementing various aid
                                and support programs to help the socially vulnerable.
                            </Paragraph>
