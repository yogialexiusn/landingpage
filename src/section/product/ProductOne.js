        ...
        <Row className="justify-content-center text-tenter">
          <Col lg="7">
            <SectionHead className="text-center">
              ...
              <p>
                An overview of <span>DashLite</span> – is fully clean and
                premium designed admin template which included beautiful
                hand-crafted components &amp; elements. Take advantage of 66
                Front-end &amp; Back-end Premium Products and{" "}
