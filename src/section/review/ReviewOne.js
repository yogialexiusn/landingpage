      ...
      <Container>
        <Row>
          <Col xs="10" sm="9" md="7" xl="6">
            <SectionHead>
              <h2 className="title">
                Creative professionalas from these compannies
              </h2>
            </SectionHead>
          </Col>
        </Row>
            ...
            <Review>
              <ReviewContent className="card card-shadow round-xl">
                <div className="card-inner card-inner-lg">
                  ...
                  <ReviewText>
                    <p>
                      Regularly updated to add new features. Developer has been
                      responsive when contacted, not that I have needed to
                      except to make suggestions.
                    </p>
                  </ReviewText>
                </div>
              </ReviewContent>
            ...
            <Review>
              <ReviewContent className="card card-shadow round-xl">
                <div className="card-inner card-inner-lg">
                  ...
                  <ReviewText>
                    <p>
                      Praising pain was bSed ut perspiciatis unde omnis iste
            ...
            <Review>
              <ReviewContent className="card card-shadow round-xl">
                <div className="card-inner card-inner-lg">
                  ...
                  <ReviewText>
                    <p>
                      Is everything cool, but I need support from you to use it,
                      because i belived is a wordpress theme, and is not to! How
                      I can do it to work for me.
                    </p>
                  </ReviewText>
                </div>
              </ReviewContent>
