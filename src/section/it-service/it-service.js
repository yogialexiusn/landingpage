  ...
  return (
    ...
    >
      <Container>
        <Row className="justify-content-center text-center">
          <Col sm="8" lg="6">
            <SectionHead>
              ...
              <p>
                Provide stable service by securing proven equipment, solutions,
                and partners Rapid response through various experts and partner
                networks
              </p>
            </SectionHead>
          </Col>
        ...
        <SectionContant>
          <h4 className="title justify-content-center text-center">
            ...
            <Col sm="8" md="6" lg="4">
              <Service>
                ...
                <ServiceText>
                  ...
                  <p>
                    SAP (B1, R3) Operation & Construction, Linked Development
                  </p>
                </ServiceText>
              </Service>
            </Col>
