        ...
        <Row className="g-gs justify-content-lg-between align-items-center">
          ...
          <Col lg="5">
            <TextBlock>
              ...
              <p>
                An overview of DashLite is fully clean and premium designed
                admin template which developped by popular framework, beautiful
                hand-crafted components &amp; elements.
              </p>
              <OutlinedChecked
                data={PluginsTwoList}
                className="list-lg list-primary list-checked-circle outlined"
              />
            </TextBlock>
          </Col>
        </Row>
