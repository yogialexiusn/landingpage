        ...
        <Row className="justify-content-center text-center">
          <Col lg="8" md="10">
            <SectionHead>
              ...
              <p>
                As Integrated distribution solution tailored to each
                country/regionDomestic and foreign reference-based retail H/W,
                solution service and as a security SolutionProvides a stable
                business environment through optimized convergence security
                services of information security expert in Lotte groups
              </p>
            </SectionHead>
          </Col>
        </Row>
                ...
                <Col md="3" xs="6">
                  <Card className="card-shadow service is-compact">
                    <div className="card-inner">
                      ...
                      <ServiceText>
                        <h6 className="title text-dark fs-14px">
                          LOTTE POS and Peripherals
                        </h6>
                      </ServiceText>
                    </div>
                  </Card>
                ...
                <Col md="3" xs="2">
                  <Card className="card-shadow service is-compact">
                    <div className="card-inner">
                      ...
                      <ServiceText>
                        <h1 className="title text-dark fs-14px">
